...
export const MOCK_STUDENTS: StudentProfile[] = [
  {
    ...
    progress: {
      'toeic-listening-master': 100,
      'toeic-grammar-booster': 50,
      'jlpt-n3-grammar': 33,
    },
    weaknesses: {
      'toeic-listening-master': ['Part 2: Indirect Responses', 'Preposition distraction'],
      'toeic-grammar-booster': ['Irregular subject-verb plural forms'],
      'jlpt-n3-grammar': ['Differentiating わけがない and はずがない'],
    },
    activityLog: [
      { date: '2026-07-11 10:30', action: 'Hoàn thành bài học SVA Rules' },
      { date: '2026-07-11 09:15', action: 'Làm Quiz Part 1 đạt điểm tối đa' },
      { date: '2026-07-10 14:22', action: 'Hỏi AI Chat về cấu trúc つもり' },
    ]
  },
  {
    id: 'student-2',
    ...
    progress: {
      'toeic-listening-master': 33,
      'toeic-grammar-booster': 0,
      'jlpt-n3-grammar': 100,
      'jlpt-n3-kanji': 50,
    },
    weaknesses: {
      'toeic-listening-master': ['Part 1: Posture verbs'],
      'jlpt-n3-grammar': ['Particle も/が omission in automatic mechanisms'],
      'jlpt-n3-kanji': ['On-yomi of 職 vs 織'],
    },
    activityLog: [
      { date: '2026-07-11 12:45', action: 'Đã hoàn thành khóa JLPT N3 Grammar' },
      { date: '2026-07-11 11:20', action: 'Hoàn thành bài kiểm tra わけがない' },
      { date: '2026-07-09 16:05', action: 'Xem video Hán tự Công sở' },
    ]
  },
  {
    id: 'student-3',
    ...
    progress: {
      'toeic-listening-master': 66,
      'toeic-grammar-booster': 100,
      'jlpt-n3-grammar': 0,
    },
    weaknesses: {
      'toeic-listening-master': ['Part 3: Office problems vocabulary'],
      'toeic-grammar-booster': ['Relative Pronoun choice under reduction'],
    },
    activityLog: [
      { date: '2026-07-11 08:30', action: 'Hoàn thành Relative Clauses quiz' },
      { date: '2026-07-10 17:12', action: 'Hỏi AI Chat giải thích Relative Clauses' },
    ]
  }
];
